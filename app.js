...
function establecerIdioma (idioma) {
    ...
    switch (idioma) {
        case 'español':
            ...
            descFirst.textContent = 'Contacto';
            contratame.textContent = 'Contacto';
            hablemos.textContent = 'Contacto';
            aboutMe.textContent = 'Contacto';
            meAbout.textContent = 'Contacto';
            descTwo.textContent = 'Contacto';
            readMore.textContent = 'Contacto';
            my.textContent = 'Contacto';
            journey.textContent = 'Contacto';
            educationTwo.textContent = 'Contacto';
            tecAux.textContent = 'Contacto';
            tecAuxDesc.textContent = 'Contacto';
            tecTitulo.textContent = 'Contacto';
            tecTituloDesc.textContent = 'Contacto';
            tituloUdemy.textContent = 'Contacto';
            descUdemy.textContent = 'Contacto';
            experience.textContent = 'Contacto';
            freelance.textContent = 'Contacto';
            freelanceDesc.textContent = 'Contacto';
            myV2.textContent = 'Contacto';
            skillsTitle.textContent = 'Contacto';
            skillsCoding.textContent = 'Contacto';
            skillsProf.textContent = 'Contacto';
            webDesign.textContent = 'Contacto';
            webDev.textContent = 'Contacto';
            engCap.textContent = 'Contacto';
            porCap.textContent = 'Contacto';
            esCap.textContent = 'Contacto';
            myV3.textContent = 'Contacto';
            developments.textContent = 'Contacto';
            onlineStore.textContent = 'Contacto';
            visitV1.textContent = 'Contacto';
            visitV2.textContent = 'Contacto';
            contactMe.textContent = 'Contacto';
            submitForm.textContent = 'Contacto';
            derechos.textContent = 'Contacto';
            break;
